...
const (
	...
	smsGatewayUser   = "sms"
	passwordFile     = "/data/adb/sms-proxy/password.txt"
	databaseFile     = "/data/adb/sms-proxy/allowlist.db"
)
...
func main() {
	log.Printf("[%s] Starting sms-proxy v%s", time.Now().Format("2006-01-02 15:04:05"), version)
